...
const UsersIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none"
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          ...
          a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197m0 0
          A5.995 5.995 0 0012 12a5.995 5.995 0 00-3-5.197M15 21a9 9 0 00-9-9" />
  </svg>
);
...
const TestIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none"
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          ...
          M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3
          m-6-4h.01M9 16h.01" />
  </svg>
);
      ...
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-grow pt-6">
          <Link to="/admin/dashboard"
                className={`flex items-center gap-4 px-6 py-3 transition-colors ${isActive("/admin/dashboard")}`}>
            <DashboardIcon /> <span>Dashboard</span>
          </Link>
          <Link to="/admin/StudentApprovalsPage"
                className={`flex items-center gap-4 px-6 py-3 transition-colors ${isActive("/admin/StudentApprovalsPage")}`}>
            <UsersIcon /> <span>Student Approvals</span>
          </Link>
          <Link to="/admin/manage-tests"
                className={`flex items-center gap-4 px-6 py-3 transition-colors ${isActive("/admin/manage-tests")}`}>
            <TestIcon /> <span>Manage Tests</span>
          </Link>
        </nav>
        <div className="p-6 border-t border-gray-200">
          <button onClick={handleLogout}
                  className="flex w-full items-center justify-center gap-3 rounded-lg bg-red-500 py-3 text-white hover:bg-red-600 transition">
